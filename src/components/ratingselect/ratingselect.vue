...
export default {
  ...
  computed: {
    positives() {
      return this.rating.filter(positive => {
        return positive.rateType === POSITIVE;
      });
    },
    negatives() {
      return this.rating.filter(negative => {
